...
It's gonna be a wearable digital badge powered by Raspberry Pi CM4<br>
...
- [Hardware](./docs/hardware/) - CM4, carrier boards, assembly, shopping list
- [Software](./docs/software/) - Architecture, API
- [Development](./docs/development/) - Setup, deployment, roadmap
